...
*/
  ...
  console.log( 'O resultado da multiplicação é: ' + multiplication((a, b) => {
    return a * b;
    })
  );
  //15

  console.log( 'O resultado da divisão é: ' + division((a, b) => {
    return a / b;
    })
  );
  //10

  console.log( 'O resto da divisão é: ' + mod((a, b) => {
    return a % b;
    })
  );
  //1
